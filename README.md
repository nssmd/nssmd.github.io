...
- `research/robot-agent-proposals/`：Robot Agent 三份英文 paper proposal（底层控制、即时响应、GPT-guided DAgger for VLA）的逐页预览、单份 PDF 与 18 页合订版下载；预览使用 PDF 页面导出的 WebP，支持手机、键盘翻页与页码深链接。旧方向的中文草稿保留在 `previous-zh.html`。
